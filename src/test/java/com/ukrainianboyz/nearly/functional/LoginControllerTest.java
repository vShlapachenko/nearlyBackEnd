...
class LoginControllerTest {
    ...
    private DatabaseUser testUser = new DatabaseUser("a","b","c","d","e",0);
    // email must be same
    private DatabaseUser wrongUser = new DatabaseUser("w","b","p","d","e",0);
    private UserDto testDto = new UserDto(testUser);
