...
public class FriendsControllerFriendsFetchingTest {
    ...
    private UserRelationship acceptedRelationship12 = new UserRelationship(testUser1.getUserId(), testUser2.getUserId(), testUser1.getUserName(), testUser2.getUserName(), Status.ACCEPTED);
