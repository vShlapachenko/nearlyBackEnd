...
public class FriendsControllerSearchMethodTest {
    ...
    private DatabaseUser testUser1 = new DatabaseUser("id2", "2", "", "k", null, 0);
    private DatabaseUser testUser2 = new DatabaseUser("id1", "1", "", "ke", null, 0);
    private DatabaseUser testUser3 = new DatabaseUser("id3", "3", "", "kek@", null, 0);
    private DatabaseUser testUser4 = new DatabaseUser("id4", "4", "", "dik", null, 0);
    private List<SecureUser> expectedUsers = DataTransferUtils.toSecureUsers(List.of(testUser1,testUser2,testUser3));
    ...
    void can_search_users(){
        ...
        assertEquals(3, users.length, "incorrect number of users was returned!");
