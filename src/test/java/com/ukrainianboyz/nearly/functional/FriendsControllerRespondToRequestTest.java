...
public class FriendsControllerRespondToRequestTest {
    ...
    private DatabaseUser testUser4 = new DatabaseUser("id4", "lol", "", "psa@", null, 0);


    private UserRelationship acceptedRelationship14 = new UserRelationship(testUser1.getUserId(), testUser4.getUserId(), testUser1.getUserName(), testUser4.getUserName(), Status.ACCEPTED);
    private UserRelationship requestedRelationship23 = new UserRelationship(testUser2.getUserId(), testUser3.getUserId(), testUser2.getUserName(), testUser3.getUserName(), Status.REQUEST_SENT);
    private UserRelationship requestedRelationship24 = new UserRelationship(testUser2.getUserId(), testUser4.getUserId(), testUser2.getUserName(), testUser4.getUserName(), Status.REQUEST_SENT);
    private UserRelationship blockedRelationship13 = new UserRelationship(testUser1.getUserId(), testUser3.getUserId(), testUser1.getUserName(), testUser3.getUserName(), Status.BLOCKED_BY_FIRST);
