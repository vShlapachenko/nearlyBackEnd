...
class DataTransferUtilsTest {
    ...
    private final DatabaseUser testUser1 = new DatabaseUser("id1", "1", "", "d", null, 0);
    private final DatabaseUser testUser2 = new DatabaseUser("id2", "2", "", "k", null, 0);
    private final SecureUser testSecureUser1 = new SecureUser("id1", "1", "", null, 0);
    private final SecureUser testSecureUser2 = new SecureUser("id2", "2", "",  null, 0);
